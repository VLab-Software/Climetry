...
class _HomeScreenState extends State<HomeScreen> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? const Color(0xFF1A2332) : const Color(0xFFF5F7FA),
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar(
            ...
            floating: false,
            pinned: true,
            backgroundColor: isDark ? const Color(0xFF2A3A4D) : const Color(0xFF4A9EFF),
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      top: 60,
                      right: 20,
                      child: Icon(Icons.cloud_outlined, size: 60, color: Colors.white.withOpacity(0.1)),
                    ),
                    Positioned(
                      top: 100,
                      left: 40,
                      child: Icon(Icons.calendar_today, size: 40, color: Colors.white.withOpacity(0.1)),
                    ),
                  ],
                ),
              ),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.location_on, color: isDark ? Color(0xFF4A9EFF) : Color(0xFF2A3A4D)),
                  SizedBox(width: 8),
                  Text(
                    _locationName,
                    style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.analytics, color: isDark ? Color(0xFF4A9EFF) : Color(0xFF2A3A4D)),
              SizedBox(width: 8),
              Text(
                'Resumo dos Eventos',
                style: TextStyle(
          ...
          Row(
            ...
            children: [
              _buildSummaryItem('🔴', 'Crítico', criticalCount, Colors.red, isDark),
              _buildSummaryItem('🟡', 'Atenção', warningCount, Colors.orange, isDark),
              _buildSummaryItem('🟢', 'Seguro', safeCount, Colors.green, isDark),
            ],
          ),
  ...
  Widget _buildSummaryItem(String emoji, String label, int count, Color color, bool isDark) {
    return Column(
      children: [
        Container(
